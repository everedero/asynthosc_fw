...
#ifndef APP_LIB_TINYOSC_H_
#define APP_LIB_TINYOSC_H_

/**
 * @defgroup lib_tinyosc Tinyosc library
 * @ingroup lib
 * @{
 *
 * @brief Tinyosc lib fork for Zephyr
 *
 * Tiny implementation of the OSC library
 * for music instrument control over IP.
 */
